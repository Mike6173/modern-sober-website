...
function StoryHero() {
  return (
    <section style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '72vh', background: '#f5f0eb' }}>
      {/* Left */}
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '140px 80px 80px' }}>
        ...
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(38px, 4.5vw, 64px)', fontWeight: 600, lineHeight: 1.05, letterSpacing: '-0.01em', color: '#1a1714', maxWidth: 480 }}>
...
function LongForm() {
  ...
  return (
    <section style={{ padding: '100px 80px', background: '#f5f0eb' }}>
...
const VALUES = [
  {
    ...
    body: "Earned through consistency, not performance. We don't announce our discipline — we live it.",
  },
  {
    title: 'DISCIPLINE AS DESIGN',
    body: "Every decision we make — in product, in community, in the words we choose — is intentional. Nothing here is accidental.",
  },
  {
    title: 'COMMUNITY OVER CROWD',
    body: "A smaller room with the right people moves faster than any crowd. We choose who we're in the room with.",
  },
];

function ValuesBand() {
  return (
    <section style={{ background: '#ede8e2', padding: '100px 80px', borderTop: '1px solid rgba(26,23,20,0.08)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 64 }}>
...
function FounderQuote() {
  return (
    <section style={{ background: '#1e1b18', padding: '100px 80px', textAlign: 'center' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(22px, 3vw, 34px)', fontWeight: 400, fontStyle: 'italic', lineHeight: 1.5, color: '#f0ebe4', marginBottom: 40 }}>
...
// ── CTA band ───────────────────────────────────────────────────────────────
function StoryCTA() {
  const [hShop, setHShop] = useState(false);
  const [hJoin, setHJoin] = useState(false);
  return (
    <section style={{ background: '#f5f0eb', padding: '100px 80px', textAlign: 'center' }}>
      <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(28px, 3vw, 44px)', fontWeight: 600, color: '#1a1714', marginBottom: 48, lineHeight: 1.15 }}>
      ...
      <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
        <Link to="/shop" style={{ textDecoration: 'none' }}>
          <button
            ...
            onMouseEnter={() => setHShop(true)} onMouseLeave={() => setHShop(false)}
          >
            SHOP
          </button>
        </Link>
        <button
          ...
          onMouseEnter={() => setHJoin(true)} onMouseLeave={() => setHJoin(false)}
        >
