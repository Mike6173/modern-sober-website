  ...
  return (
    <section style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : "1fr 1fr", minHeight: mob ? "auto" : 520 }}>
      <div style={{ background: "#1e1b18", padding: mob ? "56px 24px" : "80px 80px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "12px", fontWeight: 300, color: "#8a7d72", letterSpacing: "0.05em" }}>—</p>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 6 }}>
          <div style={{ width: 36, height: 36, borderRadius: "50%", overflow: "hidden", flexShrink: 0, border: "1.5px solid #5a4f47" }}>
            <img
